...
module.exports = exports = {
  ...
  init: function(options) {
    ...
    this._ttl = options.ttl >= 0 ? options.ttl : this._ttl;
   ...
   *
   * Options:
   *   - `invalid` callback for when the url is invalid; sends 403 by default; signature fn(req, res)
   *   - `expired` callback for when the url has expired; sends 410 by default; signature fn(req, res)
   * 
